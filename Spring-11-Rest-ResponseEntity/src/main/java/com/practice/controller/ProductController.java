...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> getProducts(){
        ...
        responseHttpHeaders.set("Version","Practice.v1");
    ...
    public ResponseEntity<ResponseWrapper> readAllProducts(){
        return ResponseEntity.ok(new ReponseWrapper("product successfully retrieved"),productService.getProducts());
    }
    ...
    public ResponseEntity<ResponseWrapper> deleteProduct(){
